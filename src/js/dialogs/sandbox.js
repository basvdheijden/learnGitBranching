  ...
  'en_US': [{
    ...
    options: {
      markdowns: [
        ...
        'Try out ',
        '[this special link](http://gitworkshop.nl?NODEMO)'
      ]
    }
  }],
  'es_AR': [{
  ...
  'ja': [{
    ...
    options: {
      markdowns: [
        ...
        '',
        '[http://gitworkshop.nl/?demo](http://gitworkshop.nl/?demo&locale=ja)',
        '',
        'このダイアログ自体を省略するには、以下のようにURLの末尾にクエリストリング`?NODEMO`を付加してアクセスしてください。',
        '',
        '[http://gitworkshop.nl/?NODEMO](http://gitworkshop.nl/?NODEMO&locale=ja)'
      ]
    }
  }, {
    type: 'ModalAlert',
  ...
  'zh_CN': [{
    ...
    options: {
      markdowns: [
        ...
        '',
        '[http://gitworkshop.nl/?NODEMO](http://gitworkshop.nl/?NODEMO)'
      ]
    }
  }, {
    type: 'ModalAlert',
  ...
  'ko': [{
    ...
    options: {
      markdowns: [
        ...
        '',
        '이 애플리케이션은 [Peter Cottle](https://github.io/pcottle)님의 [LearnGitBranching](http://gitworkshop.nl/)를 번역한 것입니다.',
        '아래 데모를 먼저 보셔도 좋습니다.',
        '',
        '<http://gitworkshop.nl/?demo&locale=ko>'
      ]
    }
  }, {
    type: 'ModalAlert',
  ...
  'uk': [{
    ...
    options: {
      markdowns: [
        ...
        'Спробуй ',
        '[це спеціальне посилання.](http://gitworkshop.nl/?NODEMO)'
      ]
    }
  }]
};
